...
# Bot information
SESSION = environ.get('SESSION', 'sanjaibot')
API_ID = int(environ.get('API_ID', '20902603'))
API_HASH = environ.get('API_HASH', '79e5caa103a9e9fb0183390b4800845d')
BOT_TOKEN = environ.get('BOT_TOKEN', "8010124589:AAHS68n-TrL1CgVWjDidhT8wXYl1gZAoebQ")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002325972163').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002332940910') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002475286547')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002475286547')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002475286547')).split()]
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://Mastersender:17032008@cluster0.dt8i8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
